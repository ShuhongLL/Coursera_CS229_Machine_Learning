...
function response = submitParts(conf, email, token, parts)
  ...
  submissionUrl_d = submissionUrl();

  responseBody = getResponse(submissionUrl_d, body);
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function submissionUrl_d = submissionUrl()
  submissionUrl_d = 'https://www-origin.coursera.org/api/onDemandProgrammingImmediateFormSubmissions.v1';
end
