...
function response = submitParts(conf, email, token, parts)
  ...
  submissionUrlReutrn = submissionUrl();

  responseBody = getResponse(submissionUrlReutrn, body);
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function submissionUrlReturn = submissionUrl()
  submissionUrlReturn = 'https://www-origin.coursera.org/api/onDemandProgrammingImmediateFormSubmissions.v1';
end
