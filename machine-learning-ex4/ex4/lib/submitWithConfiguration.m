...
function response = submitParts(conf, email, token, parts)
  ...
  submissionUrld = submissionUrl();

  responseBody = getResponse(submissionUrld, body);
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function submissionUrld = submissionUrl()
  submissionUrld = 'https://www-origin.coursera.org/api/onDemandProgrammingImmediateFormSubmissions.v1';
end
